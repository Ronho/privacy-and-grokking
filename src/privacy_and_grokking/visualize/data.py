...
def vis_dataset(name: str):
    ...
    _vis_samples_per_class(
        name, samples_by_class_watermark, num_classes, norm, postfix="_watermark"
    )
    ...
    _vis_samples_per_class(
        name, samples_by_class_noise, num_classes, norm, postfix="_gaussian_noise"
    )
    ...
    # RDM of Indices
    sbc_to_classes = lambda sbc: torch.nn.functional.one_hot(
        torch.tensor(
