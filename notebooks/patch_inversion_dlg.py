    ...
    with mlflow.start_run(run_id=run_id):
        ...
        for i in range(num_iters):
            ...
            if use_context_matching:
                ...
                context_loss = torch.nn.functional.mse_loss(
                    patch_mean, surround_mean
                ) + torch.nn.functional.mse_loss(patch_var, surround_var)
        ...
        with torch.no_grad():
            ...
            out_path = os.path.join(temp_dir, f"patch_inversion_dlg_{split}_{img_index}.png")
            plt.savefig(out_path, bbox_inches="tight")

            mlflow.log_artifact(out_path)
            print("DLG Patch inversion result saved to MLflow artifacts.")
