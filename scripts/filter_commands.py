...
def main():
    ...
    parser.add_argument("--output", type=str, default=None, help="Output file (defaults to overwriting the input file)")
    ...
    logging.info(f"Filtered {len(lines) - len(filtered_commands)} commands. {len(filtered_commands)} remaining to run.")
